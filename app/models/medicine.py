...
class Medicine(models.Model):
    ...
    origin_country = models.TextField(
        _('Страна происхождения'), max_length=255, blank=True, null=True, db_column='OriginCountry'
    )
    ...
    active_ingredients = models.TextField(
        _('Активные ингредиенты'), blank=True, null=True, db_column='ActiveIngredients'
    )
    vacation_procedure = models.TextField(_('Порядок отпуска'), blank=True, null=True, db_column='VacationProcedure')
    quantity_in_package = models.TextField(
        _('Количество в упаковке'), blank=True, null=True, db_column='QuantityInPackage'
    )
    ...
    pharmacological_effect = models.TextField(
        _('Фармакологическое действие'), blank=True, null=True, db_column='PharmacologicalEffect'
    )
    ...
    safety_precautions = models.TextField(
        _('Меры предосторожности'), blank=True, null=True, db_column='SafetyPrecautions'
    )
    pregnancy_usage = models.TextField(
        _('Применение при беременности'), blank=True, null=True, db_column='PregnancyUsage'
    )
    method_application_dosage = models.TextField(
        _('Способ применения и дозы'), blank=True, null=True, db_column='MethodApplicationDosage'
    )
    ...
    drugs_interaction = models.TextField(
        _('Взаимодействие с другими препаратами'), blank=True, null=True, db_column='DrugsInteraction'
    )
    special_instructions = models.TextField(
        _('Особые указания'), blank=True, null=True, db_column='SpecialInstructions'
    )
